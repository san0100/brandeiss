...
const messages = [
    { text: "Hello, esteemed Dean of Admissions! ✨ I am thrilled to inform you that I have discovered an exceptional student, just as you requested. I couldn't contain my excitement when I came across this promising applicant. They truly warrant your immediate attention.", speaker: "judge" },
    ...
    { text: "His name is Mr. Sanil Dulal, a shining star in the parallel universe. His skills gleam like the stars in a magical night sky, and his unique qualities are an enchantment waiting to unfold, a wizard in the making.", speaker: "judge" },

    { text: "Mr. Sanil, you say? Describe the hues of magic that adorn his potential. What makes him the chosen one?", speaker: "dean" },

    { text: "Despite hard times, lack of support, and limited resources, this applicant has stood still. Not only that, but this applicant is also a brilliant wizard and an extraordinary individual. This applicant has caught my discerning eye, and Brandeis is his top-choice school.", speaker: "judge" },

    { text: "But Judge, this is not enough to be the chosen one. I asked you to find that amazing applicant who truly belongs to Brandeis. Upon seeing his file, he really does not have good academics. The Judge, my friend, I think you made a mistake this time. What made you choose this applicant?", speaker: "dean" },

    { text: "(smiles) Dear Dean, I have not made any mistake. Even when I came across his application file, I thought the same. But sometimes, a person is much more than what they have on the paper. Mr. Sanil's life has been so much different and better after those terrible grades. He has become a better person and, yes, a more skillful one.", speaker: "judge" },

    { text: "This applicant, a diligent and resilient individual, didn't let challenging times deter him. Despite not boasting the highest grades, he worked tirelessly, teaching himself different programming languages, various cybersecurity topics, developing security tools, or educating people. He has been doing a lot more with the limited resources he has.", speaker: "judge" },

    { text: "I understand this, but The Judge, can he survive the rigorous academic curriculum at this institution?", speaker: "dean" },
    ...
    { text: "The Judge, your dedication to discovering and advocating for exceptional talent is truly commendable. As we welcome Mr. Sanil to the class of 2028, we embrace the belief in the magic of unique opportunities. Together, let's embark on a journey of limitless possibilities.", speaker: "dean" },   
];
...
function displayMessage() {
    if (index < messages.length) {
        ...
        if (message.speaker === "judge" || message.speaker === "dean") {
...
function createMessageElement(message) {
    ...
    avatar.classList.add('avatar', message.speaker === 'judge' ? 'sent' : 'received');
    ...
    nameElement.textContent = message.speaker === 'judge' ? 'Judge' : 'Dean';
