document.addEventListener("DOMContentLoaded", function() {
  ...
  var loveForJudge = document.getElementById("loveForJudge"); // Updated ID
  fadeInOut(loveForJudge, 1000, 8000);
  ...
  var judgeText = document.getElementById("judgeText"); // Updated ID
  setTimeout(function() {
    judgeText.style.display = "block";
    fadeInOut(judgeText, 1000, 5000);
  }, 15000);
